...
foreach($result as $item) {
	...
	echo '<p>Quantity: <input id="qnt'.$item['itemid'].'" type="number" name="qnt" min="1" max="10" value="1">  ';
	echo '<button class="btn" value="'.$item['itemid'].'" onclick="add(this.value)">Add to cart</button></p>';
	echo '</div>';
}
?>